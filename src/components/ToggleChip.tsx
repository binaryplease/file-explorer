type ToggleChipProps = {
  ...
  // token either way (`interaction-token`).
  compact?: boolean
  onToggle: () => void
}

// The shared on/off view-mode chip. One owner of the pressed/idle interaction
// styling (`interaction-token`), composed by every surface that carries such a
// toggle — the tree's view chips and the preview header's `wrap` control — so
