...
export function App({
  ...
  // Neither mount sets a ligature rule, here or anywhere below it: every face
  // renders with the defaults its designer shipped. The absence is deliberate —
  // do not add one back on any surface.
  return (
